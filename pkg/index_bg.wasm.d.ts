...
export const solve_known_invisible_problem: (a: number, b: number, c: number, d: number, e: number) => void;
export const solve_variable_problem: (a: number, b: number, c: number, d: number, e: number) => void;
